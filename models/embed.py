...
class TokenEmbedding(nn.Module):
    def __init__(self, c_in, d_model, tao=3, m=20, pad=True):
    ...
    def data_extract(self, ts_batch, tao=3, m=20):
        """
...
class DataEmbedding(nn.Module):
    def __init__(self, c_in, d_model, embed_type='fixed', freq='h', dropout=0.1):
        ...
        self.value_embedding = TokenEmbedding(c_in=c_in, d_model=d_model, m=20, tao=3)
